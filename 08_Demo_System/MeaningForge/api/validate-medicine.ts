...
const workPackage = JSON.parse(fs.readFileSync(path.resolve(root, "public/data/medicine-substrate-v2-development.json"), "utf8"));
const sourceText = fs.readFileSync(path.resolve(root, "public/books/luxun-medicine-zh.txt"), "utf8");
