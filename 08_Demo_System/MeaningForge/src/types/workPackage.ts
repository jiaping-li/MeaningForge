...
export interface ReaderSession {
  ...
  reader_nodes: Array<{ id: string; session_id: string; label: string; type: string; evidence_id?: string; evidence_ids: string[]; source_text_span_id?: string; source_candidate_id?: string; interpretation_type?: string; reading_intent?: "keep" | "question"; note?: string; rationale?: string; based_on_node_id?: string; created_at: string; provenance: "reader-authored"; history: Array<{ at: string; action: "create" | "revise"; label: string; type: string; note?: string }> }>;
